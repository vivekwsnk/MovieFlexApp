...
struct MoviesObjectList {
    ...
    /**
     ...
     - Parameter results
     */
    init(total_pages:Int,total_results:Int,results:[movieObject]){
    ...
    init?(json: JsonDictionay) {
        ...
        guard let results         = movieObject.createRequiredInstances(from: json , key: "results") else { return nil }
